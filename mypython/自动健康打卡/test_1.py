...
class my_hhu:
    ...
    def login(self):
        ...
        if "handleLoginSuccessed()" in loginResponse.text:
            ...
            print("{} 登录失败，请检查账号密码是否填写正确！".format(self.account))
...
if __name__ == '__main__':
    students = [['1962310318', '182674', 'A335B048C8456F75E0538101600A6A04', '年炳强', '622628200104182674'
                    , '物联网院', '2019级', '通信', '通信19_3', '常州校区3号楼', '303', '18394947193']
                ]

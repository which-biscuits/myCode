...
public class mainController implements Initializable{
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // 通过用户性别选择用户头像
        Image photo = new Image(String.valueOf(getClass().getResource("../resource/images/femalePhoto.png")));
        if (CacheDataBean.getNowUser() != null ) {
            ...
            if (CacheDataBean.getNowUser().getUserSex() == 1)
                photo = new Image(String.valueOf(getClass().getResource("../resource/images/malePhoto.png")));
        }
    ...
    void ServiceOnClick(ActionEvent event) throws IOException {
        ...
        workingSpace.getChildren().clear();
        FXMLLoader loader = new FXMLLoader();	// 创建对象
        InputStream in = getClass().getResourceAsStream("../resource/fxml/service.fxml");
        AnchorPane page = loader.load(in); // 对象方法的参数是InputStream，返回值是Object
        workingSpace.getChildren().add(page);
    }
    ...
    void distributionOnClick(ActionEvent event) throws IOException {
        ...
        workingSpace.getChildren().clear();
        FXMLLoader loader = new FXMLLoader();	// 创建对象
        InputStream in = getClass().getResourceAsStream("../resource/fxml/distribution.fxml");
        AnchorPane page = loader.load(in); // 对象方法的参数是InputStream，返回值是Object
        workingSpace.getChildren().add(page);
    }
    ...
    void myPurchasesOnClick(ActionEvent event) throws IOException {
        ...
        workingSpace.getChildren().clear();
        FXMLLoader loader = new FXMLLoader();	// 创建对象
        InputStream in = getClass().getResourceAsStream("../resource/fxml/myPurchases.fxml");
        AnchorPane page = loader.load(in); // 对象方法的参数是InputStream，返回值是Object
        workingSpace.getChildren().add(page);
    }
    ...
    void personalDataOnClick(ActionEvent event) throws IOException {
        ...
        workingSpace.getChildren().clear();
        FXMLLoader loader = new FXMLLoader();	// 创建对象
        InputStream in = getClass().getResourceAsStream("../resource/fxml/personalData.fxml");
        AnchorPane page = loader.load(in); // 对象方法的参数是InputStream，返回值是Object
        workingSpace.getChildren().add(page);
    }
    ...
    void changePasswordOnClick(ActionEvent events) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../resource/fxml/changePassword.fxml"));

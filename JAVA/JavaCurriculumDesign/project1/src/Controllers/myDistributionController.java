        ...
        public void run() {
            ...
            if (goods.getSaleOut() == 0) {
                ...
                if (goods.getOrCheck() == 0) {
                    check.setImage(new Image(String.valueOf(getClass().getResource("../resource/images/waiteCheck.png"))));
                } else if (goods.getOrCheck() == -1) {
                    check.setImage(new Image(String.valueOf(getClass().getResource("../resource/images/noPass.png"))));
                }

...
public class loginController implements Initializable {
    ...
    void loginInOnClick(ActionEvent event) throws IOException {
        if (userId.getText() == null || userId.getText().equals("")) {
            ...
            if (nowUser == null) {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/userApplication/resource/fxml/main.fxml"));
    ...
    void registerOnClick(ActionEvent event) throws IOException {
        // 注册窗口
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/userApplication/resource/fxml/register.fxml"));
        Pane root = loader.load();

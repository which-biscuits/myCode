    ...
    class addToServiceView implements Runnable {
        ...
        public void run() {
            ...
            for (ServiceBean service : serviceList) {
                ...
                image.setImage(new Image(String.valueOf(getClass().getResource("/userApplication/resource/images/femalePhoto.png"))));
                if (service.getOrSend() == 0) {
                    if (CacheDataBean.getNowUser().getUserSex() == 1) {
                        image.setImage(new Image(String.valueOf(getClass().getResource("/userApplication/resource/images/malePhoto.png"))));
                    }

...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        Class.forName("userApplication.utils.SQLUtil");

        CacheDataBean.setMyStage(primaryStage);     // 保存 程序主窗口 对象
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/userApplication/resource/fxml/login.fxml"));  // 加载 login 页面
